...
Kolejn- metryk- zwi-zan- z ilo-ci- linii kodu w plikach jest miara ilo-ci linii kodu na plik.
Metryka ta jest szczeg-lnie wa-na ze wzgl-du na to, -e zapewnia ewaluacj- projektu programistycznego
jako ca-o-ci. Wa-ne jest, aby nie wlicza- do tej metryki plik-w konfiguracyjnych ani plik-w
wynikowych budowania.

Do wyliczenia LOCPF mo-na wykorzysta- metryk- LOC:
\begin{equation}
...
najmniejsza. Jest kilka sposobów jej obliczania. Definiuje siê:
\begin{itemize}
...
historiê zmiany plików i pozwala na przejrzyst¹ wizualizacjê zebranych danych.
	...
	Eclipse \cite{website:eclipse} otwartoŸród³ow¹ platform¹ na bazie której zosta³o stworzone zintegrowane œrodowisko
