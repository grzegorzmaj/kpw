...
historiê zmiany plików i pozwala na przejrzyst¹ wizualizacjê zebranych danych.
	...
	W proponowanej wtyczce zosta³y zaimplementowane dwa podstawowe miary pracy programisty
	...
	\subsection{Utworzona wtyczka}
		...
		\begin{figure}
			\centering
			\includegraphics[width=\textwidth]{graphics/wybor.jpg}
		...
		Widok pojedynczego projektu zosta³ pokazany na rysunku \ref{fig:view}. Mo¿na te¿ zwin¹æ pliki 
		nale¿¹ce do jednego z projektów, wtedy bêdzie wyœwietlana tylko nazwa danego projektu.
		...
		Dostêp do pozosta³ej historii zmian plików dostêpny jest poprzez dwukrotne klikniêcie na 
