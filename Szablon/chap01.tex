...
Jako strukturê bazê danych wybrano plik xml. Takie podejœcie umo¿liwia prosty i czytelny zapis zmian. Wykorzystanie pliku xml, ³atwego do analizy, pozwala na wykorzystanie budowanej bazy nie tylko w tej wtyczce, ale mog¹ go wykorzystywaæ inne programy badaj¹ce prace programisty.

Dla bazy danych przyjêto model addytywny, tzn. ka¿da kolejna zmiana pliku zostaje dopisana nowym elementem 
w pliku xml. Takie rozwi¹zanie jest proste w z³o¿eniach i ³atwe do analizy jednak dla du¿ej iloœci zmian
wielkoœæ pliku mo¿e znacznie wzrosn¹æ, co nie jest dobrym zjawiskiem. Problemem przy przetwarzaniu bazy mo¿e byæ te¿ jej rozmiar. Poniewa¿ wtyczka na bie¿¹co aktualizuje wyœwietlane dane, dla bardzo du¿ej bazy danych analiza mo¿e zaj¹æ zbyt du¿o czasu, aby zapewniæ p³ynn¹ pracê programu. Rozwi¹zaniem tego problemu
mo¿e byæ zmiana u³o¿enia nowych wpisów do bazy danych, tak by paser nie musia³ analizowaæ ca³ego pliku a
jedynie ostatnie n ¿¹danych zmian.

Utworzona wtyczka jest dobrym narzêdziem do œledzenia ci¹g³ego postêpu prac na poziomie, którego nie 
udostêpniaj¹ nam systemy kontroli wersji czy platformy zarz¹dzania projektem, które analizuj¹ czêœci kodu 
przesy³ane w wiêkszych czêœciach.
