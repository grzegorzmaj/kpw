...
Niestety takie podejœcie nie jest pozbawione wad. Reprezentacja danych w formacie XML nie jest
optymalne pod wzglêdem zajêtoœci pamiêci. Poza tym konstrukcja programu zak³ada, ¿e plik jest
otwierany, parsowany i zamykany w ka¿dej iteracji pracy programisty, gdzie iteracjami nazywa siê
okresy miêdzy kolejnymi zapisaniami zmian w œledzonych plikach. Jest to równie¿ podejœcie 
nieoptymalne gdy¿ przy wiêkszych rozmiarach bazy danych, ci¹g³e parsowanie pliku xml, mo¿e byæ
bardzo obci¹¿aj¹ce dla procesora.

Wa¿n¹ rzecz¹, o której nale¿y nie zapominaæ, jest ³atwoœæ u¿ytkowania i p³ynnoœæ dzia³ania
oprogramowania s³u¿¹cego do pomiaru jakoœci pracy oraz kodu. Programista nie powinien odwracaæ 
swojej uwagi od g³ównego zadania jakim jest tworzenie kodu przez obecnoœæ programów takich jak
zaproponowana wtyczka. Pomiar pracy, agregacja danych i wstêpna analizach powinna byæ 
transparentna dla programisty, a wiêc nie wymagaæ od niego dodatkowych cyklicznych akcji oraz
nie spowalniaæ pracy œrodowiska. Jednoczeœnie, dla osoby zainteresowanej wynikami, reprezentacja
wyników powinna byæ czytelna i dobrze skategoryzowana.

Utworzona wtyczka rzuca œwiat³o na szerokie zagadnienie jakim jest pomiar jakoœci pracy 
programisty. Nietrudno jest wyobraziæ sobie jakie mo¿liwoœci analizy stwarza³oby obszerne 
narzêdzie tego typu pod³¹czone do œrodowiska programistycznego. Du¿e korporacje zajmuj¹ce siê
wytwarzaniem oprogramowania, chêtnie inwestuj¹ pieni¹dze w takie narzêdzia w celu zwiêkszenia
wydajnoœci pracy, oraz przede wszystkim jakoœci kodu.
