...
\begin{itemize}
	...
	b³êdów strukturalnych kodu i b³êdów przebiegu programu. Pmo¿liwia pracê z najpopularniejszymi jêzykami
	C, C++, Java czy C#.
...
It is also equipped with the Pyreverse module that allows UML diagrams to be generated from Python code.
	\item CodeSonar (Java).
	 Defect detection (Buffer overruns, memory leaks, ...), concurrency and security checks, architecture visualization and software metrics for C, C++ and Java source code.
\end{itemize}
