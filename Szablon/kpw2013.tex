...
% Szablon ksi¹¿ki
% Autor: Tomasz Kubik
% udostêpniany na prawach CreativeCommons: SA-BY-NC
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%    Pakiety podstawowe                                  %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage[cp1250]{inputenc} %ustawienie kodowania znaków
...
\sloppy  % wyrównanie z dwóch stron
...
\makepagestyle{intro}
\makeoddhead{intro}{}{}{\small\color{nicered}\slshape S³owo wstêpne}
\makeevenhead{intro}{\small\color{nicered}\slshape S³owo wstêpne}{}{}
